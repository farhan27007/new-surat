            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header card-header-icon card-header-rose">
                  ...
                  <h4 class="card-title title-per-section">Daftar user</h4>
                      ...
                      <tbody>
                        ...
                        <?php for ($i=0; $i < 1 ; $i++) { ?>
                          <tr>
                            ...
                            <td>Super admin</td>
                            <td>
                              <a href="detail-user.php" class="btn btn-repost btn-link">
                                <i class="material-icons">remove_red_eye</i>
                              </a>
                              <a href="edit-user.php" class="btn btn-twitter btn-link">
